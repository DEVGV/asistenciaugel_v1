...
return new class extends Migration
{
    ...
    {
        Schema::create('conasis.t_ampliaDeduceHoras', function (Blueprint $table) {
            ...
            $table->smallInteger('toleranciaPre')->nullable();
            $table->smallInteger('toleranciaPost')->nullable();
    ...
    {
        Schema::dropIfExists('conasis.t_ampliaDeduceHoras');
    }
};
