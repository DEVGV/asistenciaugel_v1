...
return new class extends Migration
{
    ...
    {
        Schema::create('conasis.t_feriadoLabTrabajador', function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->bigInteger('diaNoLaborable_id');
            ...
            $table->foreign('diaNoLaborable_id')->references('id')->on('conasis.t_diasNoLaborables');
    ...
    {
        Schema::dropIfExists('conasis.t_feriadoLabTrabajador');
    }
};
