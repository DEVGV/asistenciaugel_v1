...
class StoreInstEducRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'codigoInstitucion' => ['required', 'string', 'max:20', 'unique:t_institucionesEduc,codigoInstitucion'],
    ...
    public function toDTO(): CreateInstEducDTO
    {
        return CreateInstEducDTO::from($this->validated());
    }
}
