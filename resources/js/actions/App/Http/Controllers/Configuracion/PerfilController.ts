...
/**
* @see \App\Http\Controllers\Configuracion\PerfilController::syncPermisos
* @see app/Http/Controllers/Configuracion/PerfilController.php:67
* @route '/perfiles/{perfil}/permisos'
*/
export const syncPermisos = (args: { perfil: string | { id: string } } | [perfil: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: syncPermisos.url(args, options),
    method: 'post',
})

syncPermisos.definition = {
    methods: ["post"],
...
* @route '/perfiles/{perfil}/permisos'
*/
syncPermisos.url = (args: { perfil: string | { id: string } } | [perfil: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { perfil: args }
    }
    ...
    return syncPermisos.definition.url
            .replace('{perfil}', parsedArgs.perfil.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
...
* @route '/perfiles/{perfil}/permisos'
*/
syncPermisos.post = (args: { perfil: string | { id: string } } | [perfil: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: syncPermisos.url(args, options),
    method: 'post',
})
...
* @route '/perfiles/{perfil}/permisos'
*/
const syncPermisosForm = (args: { perfil: string | { id: string } } | [perfil: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: syncPermisos.url(args, options),
    method: 'post',
})
...
* @route '/perfiles/{perfil}/permisos'
*/
syncPermisosForm.post = (args: { perfil: string | { id: string } } | [perfil: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
    action: syncPermisos.url(args, options),
    method: 'post',
})

syncPermisos.form = syncPermisosForm

const PerfilController = { index, store, update, destroy, syncPermisos }
