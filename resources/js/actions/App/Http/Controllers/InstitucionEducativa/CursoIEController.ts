...
/**
* @see \App\Http\Controllers\InstitucionEducativa\CursoIEController::store
* @see app/Http/Controllers/InstitucionEducativa/CursoIEController.php:18
* @route '/instituciones/{institucione}/cursos'
*/
...
store.definition = {
    methods: ["post"],
    url: '/instituciones/{institucione}/cursos',
...
const CursoIEController = { store, update, destroy }

export default CursoIEController