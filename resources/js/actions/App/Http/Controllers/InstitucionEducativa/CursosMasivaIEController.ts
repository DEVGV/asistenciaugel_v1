...
/**
* @see \App\Http\Controllers\InstitucionEducativa\CursosMasivaIEController::store
* @see app/Http/Controllers/InstitucionEducativa/CursosMasivaIEController.php:17
* @route '/instituciones/{institucione}/cursos-masivos'
*/
...
store.definition = {
    methods: ["post"],
    url: '/instituciones/{institucione}/cursos-masivos',
...
const CursosMasivaIEController = { store }

export default CursosMasivaIEController