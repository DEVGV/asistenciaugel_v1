...
/**
* @see \App\Http\Controllers\Entidad\EntidadController::search
* @see app/Http/Controllers/Entidad/EntidadController.php:54
* @route '/api/entidades/search'
*/
...
const EntidadController = { index, store, update, destroy, search }
